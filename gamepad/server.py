...
GAME = GAMES['knight']  # change this when multiple games are available
...
def popenAndCall(onExit, *popenArgs):
    ...
    def runInThread(onExit, *popenArgs):
        ...
        command = f'"{tic80_exe}" --cmd="cd Radna/HologameV/src & load game.py & run"'
...
def ctrl():
    ...
    tic80_exe = r'C:\Users\Nimaj\Desktop\tic80.exe'
    popenAndCall(lambda: game_exit_callback(), tic80_exe)
    GAME_STARTED = True
    return render_template('ctrl.html', game='knight')
